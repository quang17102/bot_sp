...
from workers import handle_cvc, handle_cks, handle_checkmail, handle_mailfree, handle_addmail, handle_newmail, handle_qr
...
def main():
    ...
    job_queue.register_handler("addmail", handle_addmail)
